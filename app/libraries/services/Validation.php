<?php
    ...
    class Validation {
        ...
        public function pattern($name){
            ...
            if($name == 'array'){
                ...
                if(!is_array($this->value)){
                    $this->errors[] = 'Formato campo '.$this->name.' invalid.';
                }
                ...
                if($this->value != '' && !preg_match($regex, $this->value)){
                    $this->errors[] = 'The Format of '.$this->name.' is invalid.';
                }
        ...
        public function customPattern($pattern){
            ...
            $regex = '/^('.$pattern.')$/u';
            if($this->value != '' && !preg_match($regex, $this->value)){
                $this->errors[] = $this->name.' entered is invalid.';
            }
            return $this;
        ...
        public function min($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) < $length){
                    $this->errors[] = 'Value entered for '.$this->name.' inferior than the minimum value';
                }
        ...
        public function max($length){
            ...
            if(is_string($this->value)){
                ...
                if(strlen($this->value) > $length){
                    $this->errors[] = 'Value entered for '.$this->name.' Greated than the maximum value';
                }
        ...
        public function equal($value){
            ...
            if($this->value != $value){
                $this->errors[] = 'Value entered for '.$this->name.' non not matching.';
            }
            return $this;
		...
		public static function all_in_is_empty($array, $offset){
			$count = 0;
